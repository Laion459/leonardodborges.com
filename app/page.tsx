...
export default function HomePage() {
  ...
  return (
    <HorizontalScroller>
      <section
        data-scroll-section
        className="home-section horizontal-section gap-8 lg:gap-12"
      >
        <div className="space-y-6" data-animate>
          <p className="text-xs uppercase tracking-[0.35em] text-accent">Apresentação</p>
          <h1 className="font-display text-5xl leading-tight uppercase tracking-[0.25em] sm:text-6xl lg:text-7xl">
            Leonardo Dario Borges
          </h1>
          <p className="max-w-xl text-lg text-foreground/70">
            Desenvolvedor de Software Criativo Focado em Soluções Inovadoras e Experiências de Usuário Memoráveis.
          </p>
        </div>
      </section>

      <section data-scroll-section className="home-section horizontal-section">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          ...
          <figure
            className="group relative aspect-[16/10] overflow-hidden rounded-3xl border border-foreground/10"
            data-animate
          >
            <Image
      ...
      <section data-scroll-section className="home-section horizontal-section">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-center">
          <div className="space-y-6" data-animate>
            ...
            <p className="max-w-xl text-base text-foreground/70">
              Apaixonado por transformar ideias complexas em realidade digital. Atualmente cursando Ciência da Computação na
              UNIVALI e sempre em busca de novos desafios que unam tecnologia, estética e impacto real.
            </p>
            <Link
              href="/sobre"
              data-cursor="interactive"
      ...
      <section data-scroll-section className="home-section horizontal-section">
        <div className="space-y-6" data-animate>
          ...
          <p className="max-w-xl text-base text-foreground/70">
            Disponível para projetos freelance e oportunidades de colaboração. Vamos tirar sua ideia do papel com tecnologia de
            ponta, narrativa envolvente e foco em resultados de negócio.
          </p>
          <Link
            href="/contato"
            className="inline-flex items-center gap-3 text-sm uppercase tracking-[0.35em] text-accent"
